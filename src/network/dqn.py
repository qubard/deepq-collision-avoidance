...
class DeepQNetwork():
    ...
    def __init__(self, input_size, action_size, num_episodes, \
                 gamma=0.9, learning_rate=0.01, max_memory_size=100000, \
    ...
    def generate_action(self, probability):
        ...
        if explore_prob < probability:
            ...
            qvals = self.sess.run(self.model, feed_dict={self.inputs_: self.env.state})
    ...
    def train(self):
        ...
        for episode in range(self.num_episodes):
            ...
            self.env = "" # Create the environment
            ...
            for _ in range(self.max_steps):
                action, action_vec, explore_prob = self.generate_action(prob)
                ...
                # Sample a minibatch and update the network's parameters
                ...
                # Run and compute loss against target_q
